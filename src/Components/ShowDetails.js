        ...
        <div className='show_container'>
          ...
          <div className='show_child'>
                ...
                <div className='show_summary'>
                    <p><strong>Summary:</strong> {removeHtmlTags(showDetails.show.summary)}</p>
            ...
            <button onClick={handleOpenModal} className='book_ticket'>Book Ticket</button>
        </div>
      )}
      {isModalOpen===true &&
        <TicketModal isOpen={isModalOpen} onClose={handleCloseModal} movieName={showDetails.show.name} />
      }
    </div>
  );
};
